...
(
    ...
    CONSTRAINT FK_TAIKHOAN FOREIGN KEY(CCCD) 
...
(
    ...
    CONSTRAINT FK_HOADON2 FOREIGN KEY(MADONHANG) 
...
(
    ...
    CONSTRAINT FK_NHANVIEN FOREIGN KEY (MANVQUANLY) 
...
(
    ...
    CONSTRAINT FK_BAN FOREIGN KEY(SOPHONG) 
...
(
    ...
    CONSTRAINT FK_SDTKHACHHANG FOREIGN KEY(CCCDKH) 
        REFERENCES KHACHHANG(CCCD)
)
...
(
    ...
    CONSTRAINT FK FOREIGN KEY (MADONVI) 
...
(
    MANHANVIEN VARCHAR(100) PRIMARY KEY,
    CONSTRAINT FK_PHUCVU FOREIGN KEY (MANHANVIEN) 
        REFERENCES NHANVIEN(MANHANVIEN)
)
...
(
    MANHANVIEN VARCHAR(100) PRIMARY KEY,
    CONSTRAINT FK_DAUBEP FOREIGN KEY (MANHANVIEN) 
        REFERENCES NHANVIEN(MANHANVIEN)
)
...
(
    MANHANVIEN VARCHAR(100) PRIMARY KEY,
    CONSTRAINT FK_THNGAN FOREIGN KEY (MANHANVIEN) 
        REFERENCES NHANVIEN(MANHANVIEN)
)
...
(
    ...
    CONSTRAINT FK_TTLIENHE FOREIGN KEY (MANHANVIEN) 
        REFERENCES NHANVIEN(MANHANVIEN)
)
...
(
    ...
    CONSTRAINT FK_MONAN2 FOREIGN KEY (TEN,VERSION) 
        REFERENCES FOODANDDRINK(TEN,VERSION)
)
...
(
    ...
    CONSTRAINT FK_DOUONG2 FOREIGN KEY (TEN,VERSION) 
        REFERENCES FOODANDDRINK(TEN,VERSION)
)
...
(
    MADONHANG VARCHAR(100) PRIMARY KEY,
    CCCD VARCHAR(100),
    CONSTRAINT FK_DHKH1 FOREIGN KEY(MADONHANG) 
        REFERENCES DONHANG(MADONHANG),
    CONSTRAINT FK_DHKH2 FOREIGN KEY(CCCD) 
        REFERENCES KHACHHANG(CCCD)
)
...
(
    MADONHANG VARCHAR(100) PRIMARY KEY,
    MANHANVIEN VARCHAR(100),
    CONSTRAINT FK_DHPV1 FOREIGN KEY(MADONHANG) 
        REFERENCES DONHANG(MADONHANG),
    CONSTRAINT FK_DHPV2 FOREIGN KEY(MANHANVIEN) 
        REFERENCES PHUCVU(MANHANVIEN)
)
...
(
    ...
    CONSTRAINT FK_DH1 FOREIGN KEY(MADONHANG) 
        REFERENCES DONHANG(MADONHANG),
    CONSTRAINT FK_DH2 FOREIGN KEY(SOBAN,SOPHONG) 
        REFERENCES BAN(SOBAN,SOPHONG)
)
...
(
    ...
    CONSTRAINT FK_VANCHUYEN_MDH FOREIGN KEY(MDH) 
        REFERENCES DONHANG(MADONHANG),
    CONSTRAINT FK_DVVANCHUYEN FOREIGN KEY(MADVVANCHUYEN) 
        REFERENCES DONVIVANCHUYEN(MADONVI)
)
...
(
    ...
    CONSTRAINT FK_FD_DH_TENMON FOREIGN KEY(TEN,VERSION) 
        REFERENCES FOODANDDRINK(TEN,VERSION),
    CONSTRAINT FK_FD_DH_MDH FOREIGN KEY(MDH) 
        REFERENCES DONHANG(MADONHANG)
)
...
(
    ...
    CONSTRAINT FK_HDVCH1 FOREIGN KEY(MAHOADON) 
        REFERENCES HOADON(MAHOADON),
    CONSTRAINT FK_HDVCH2 FOREIGN KEY(MAVOUCHER) 
...
(
    ...
    CONSTRAINT FK_HDTN1 FOREIGN KEY(MAHOADON) 
        REFERENCES HOADON(MAHOADON),
    CONSTRAINT FK_HDTN2 FOREIGN KEY(MANHANVIEN) 
        REFERENCES THUNGAN(MANHANVIEN)
)
...
(
    ...
    CONSTRAINT FK_MANVPHUCVU FOREIGN KEY(MANVPHUCVU) 
        REFERENCES PHUCVU(MANHANVIEN),
    CONSTRAINT FK_SOPHONG FOREIGN KEY(SOPHONG) 
        REFERENCES PHONG(SOPHONG)
)
...
(
    ...
    CONSTRAINT FK_TENMON FOREIGN KEY (TEN,VERSION) 
        REFERENCES MON_AN(TEN,VERSION),
    CONSTRAINT FK_MANVDAUBEP FOREIGN KEY (MANVDAUBEP) 
        REFERENCES DAUBEP(MANHANVIEN)
)
...
(
    ...
    CONSTRAINT FK_FD_VOUCHER_APDUNG_TENMON FOREIGN KEY (TEN,VERSION) 
        REFERENCES FOODANDDRINK(TEN,VERSION),
    CONSTRAINT FK_FD_VOUCHER_APDUNG_MAVOUCHER FOREIGN KEY (MAVOUCHER) 
        REFERENCES VOUCHER(MAVOUCHER)
)

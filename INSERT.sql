...
('NH1000K',NULL,NULL,1000000,NULL,'2023-10-20','2023-12-29','Tren 2 trieu dong'),
('NH200XYZ','Sup to yen hat sen,Xuc xich bo Kobe nuong','1 Bearbrick Bling',NULL,NULL,'2023-01-02','2023-02-02','Tren 1 trieu dong'),
('NHANTHAGA','Loi vai bo My nuong, Sup miso, Hau chien gion, Bap gio heo xong khoi',NULL,5000000,NULL,'2023-04-10','2023-04-17','Tren 3 trieu dong'),
('NHANUONG','Xoi bo cau, 1 nuoc ep cam, 1 bia Heineken Ha Lan','2 Gau Bong',NULL,5,'2023-11-30','2023-12-5','Tren 5 tram nghin dong'),
('NHABCDEF','Salad cac loai dau,Dua luoi','1 chai ruou vang',NULL,10,'2023-12-30','2024-01-01',NULL),
('NH2000K','Dui cuu nuong,Loi vai bo My luc lac',NULL,500000,NULL,'2023-07-09','2023-10-01','Tren 3 trieu dong')
...
VALUES
('2110152','Nguyen Thanh Hai','Nam','2003-07-02','To dan pho Hoa Tien, Phuong Cam Nghia, TP Cam Ranh, Tinh Khanh Hoa','2019-12-12','MB:32758740','Bang Dai Hoc',10000000,NULL,NULL),
('2110826','Phan Thanh Binh','Nam','2003-10-13','62 Vo Van Tan, Phuong 6, Quan 3, TP Ho Chi Minh','2019-01-01','VCB:028374072','Chung chi IELTS 7.0',NULL,30000,'2110152'),
('2113290','Quach Trung Hao','Nam','2002-11-12','27 Tran Quoc Thao, Phuong 6, Quan 3, TP Ho Chi Minh','2019-10-01','TCB:02837013','Bang Dai Hoc',NULL,29000,'2110152'),
('2011867','Le Quang Phuc','Nam','2001-01-01','7 Nguyen Chi Thanh, TP Da Lat, Tinh Lam Dong','2023-02-27','MB:02834031','Bang Dai Hoc',8000000,NULL,'2110152'),
('2115181','Nguyen Thanh Tuan','Nam','2004-10-10','121 Xo Viet Nghe Tinh, Phuong 17, Quan Binh Thanh, TP Ho Chi Minh','2022-11-11','ACB:028740113','Bang TOEIC 650',9500000,NULL,'2110152'),
('2111011','Nguyen Thi Dao','Nu','2005-11-11','64 Nguyen Thoi Trung, Phuong 6, Quan 5, TP Ho Chi Minh','2023-10-10','VCB:01387049',NULL,NULL,27000,'2110152'),
('2091228','Cao Hoang Cam Tu','Nu','2003-04-21','To dan pho Hoa Binh, Phuong Cam Phuc Bac, TP Cam Ranh, Tinh Khanh Hoa','2017-01-09','MB:013801029','Bang Ke Toan',10000000,NULL,'2110152')

...
(
    ...
    CONSTRAINT FK_FD_DH_TENMON FOREIGN KEY(TEN,VERSION) REFERENCES MON_AN(TEN,VERSION),
...
(
    ...
    CONSTRAINT FK_FD_VOUCHER_APDUNG_TENMON FOREIGN KEY (TEN,VERSION) REFERENCES MON_AN(TEN,VERSION),
...
(
    ...
    CONSTRAINT FK_FD_VOUVHER_TANG_TENMON FOREIGN KEY(TEN,VERSION) REFERENCES MON_AN(TEN,VERSION),

...
BEGIN
    ...
    BEGIN
        SELECT @MA = MDH FROM inserted
    END
    ELSE
    BEGIN
        SELECT @MA = MDH FROM deleted
    END
    ;WITH ST AS
    (
    ...
    BEGIN
        ...
        SET TONGTIEN = 
        CASE
            WHEN HOADON.MADONHANG = @MA THEN (SELECT SUM(GIA) FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG)
            ELSE (SELECT SUM(GIA) FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG )
        END
    END
    ...
    BEGIN
        ...
        SET TONGTIEN = 
        CASE
            WHEN HOADON.MADONHANG = @MA THEN (SELECT SUM(GIA)-@VOUCHERTIEN FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG)
            ELSE (SELECT SUM(GIA) FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG)
        END
    END
    ...
    BEGIN
        ...
        SET TONGTIEN = 
        CASE 
        WHEN HOADON.MADONHANG = @MA THEN (SELECT SUM(GIA)*(1-@VOUCHERPHANTRAM/100) FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG)
        ELSE (SELECT SUM(GIA) FROM DONHANG_FD WHERE DONHANG_FD.MDH = HOADON.MADONHANG )
        END
    END
END
